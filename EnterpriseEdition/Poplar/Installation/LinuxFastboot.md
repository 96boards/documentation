...
This section show how to install a new operating system to your Board-X using the fastboot method on a Linux host computer.

***

- **Step 1**: Make sure fastboot is set up on host computer
- **Step 2**: Connect host computer to Board-X
- **Step 3**: Boot Board-X into fastboot mode
- **Step 4**: Flash Bootloader
- **Step 5**: Recall location of all downloaded files
- **Step 6**: Unzip all files
- **Step 7**: Flash all files to the Board-X
- **Step 8**: Reboot Board-X
...
- Board-X must be powered off (unplugged from power)
- Make sure microSD card slot on Board-X is empty
- S6 switch on Board-X must be set to ‘0-0-0-0’. All switches should be in “off” position
- Connect USB to microUSB cable from host computer to Board-X

#### **Step 3**: Boot Board-X into fastboot mode

**Please read all bullet points before attempting**

- Press and hold the Vol (-) button on the Board-X, this is the S4 button. Board-X should still NOT be powered on
- While holding the Vol (-) button, power on the Board-X by plugging it in
- Once Board-X is plugged into power, release your hold on the Vol (-) button.
...
**At this point you should be connected to your Board-X with a USB to microUSB cable. Your Board-X should be booted into fastboot mode and ready to be flashed with the appropriate images.**
...
#### **Step 7**: Flash all images to the Board-X
