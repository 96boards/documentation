...
permalink: /documentation/consumer/dragonboard/dragonboard410c/guides/using-usb/
redirect_from:
- /db410c-getting-started/Guides/using-usb.md/
- /documentation/ConsumerEdition/DragonBoard-410c/Guides/using-usb/
- /documentation/consumer/dragonboard410c/guides/using-usb/
---
# Using USB
