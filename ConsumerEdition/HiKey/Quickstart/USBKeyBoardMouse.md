...
All standard USB Type-A keyboard and mouse should with with any 96Boards. With two available USB type-A ports, it is recommended to use an all-in-one keyboard with built in, multi-touch touchpad. Using one of these all-in-one keyboard/mouse devices will leave an open USB type-A port for other uses. 
...
<a href="http://www.logitech.com/en-us/product/wireless-touch-keyboard-k400r" target="_blank"><img src="http://i.imgur.com/i4ymRJ0.jpg" data-canonical-src="http://i.imgur.com/i4ymRJ0.jpg" width="200" height="150" /></a> |
