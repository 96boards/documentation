...
The NOOBS method allows you to place a microSD card into a DragonBoard™ 410c to automatically boot an operating system on your board, from the SD card. This is the most simple of install methods and should be used by beginners.
